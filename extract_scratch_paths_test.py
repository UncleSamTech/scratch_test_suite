...
class Scratch_Path:
    ...
    def generate_simple_graph_optimized(self, file_path, path_name,proj_number):
        ...
        with open(f"/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_models_ngram3/thesis_models/test_models/general_logs/extracted_paths_logs_unique_final_test_upd_{proj_number}.txt", "a") as exp:
            for each_hash in hashes:
                contents = self.get_all_contents(each_hash)
...
sc_path.generate_simple_graph_optimized("/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_models_ngram3/thesis_models/train_models/train_data/sampled_test_projects/sampled_120_test_projects.csv","/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_models_ngram3/thesis_models/test_models/test_data/list_path_120/",120)
