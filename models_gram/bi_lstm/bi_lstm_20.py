...
class bi_lstm_scratch:
    ...
    def consolidate_data_train(self,train_path,result_path,test_path,model_number,logs_path):
    ...
    def get_vocab_size(self,tokenizer_path,proj_number,run):
        with open(f"{tokenizer_path}tokenized_file_50embedtime1_{run}.pickle","rb") as tk:
            tokenz = pickle.load(tk)
            vocab_size = len(tokenz.word_index) + 1
            print(f"vocab size for {proj_number} bilstm is {vocab_size}")
...
cl_ob.view_model_summary("/media/crouton/siwuchuk/newdir/vscode_repos_files/method/models/bilstm/20/main_bilstm_scratch_model_150embedtime1_main_sample_project20_6_1.keras")
...
cl_ob.view_model_summary("/media/crouton/siwuchuk/newdir/vscode_repos_files/method/models/bilstm/20/main_bilstm_scratch_model_150embedtime1_main_sample_project20_6_3.keras")
cl_ob.view_model_summary("/media/crouton/siwuchuk/newdir/vscode_repos_files/method/models/bilstm/20/main_bilstm_scratch_model_150embedtime1_main_sample_project20_6_4.keras")
cl_ob.view_model_summary("/media/crouton/siwuchuk/newdir/vscode_repos_files/method/models/bilstm/20/main_bilstm_scratch_model_150embedtime1_main_sample_project20_6_5.keras")
...
#cl_ob.consolidate_data_train("/mnt/siwuchuk/vscode/output_train","/mnt/siwuchuk/vscode/models/20/","/mnt/siwuchuk/vscode/output_test",10,"/mnt/siwuchuk/vscode/logs/20")
...
for i in range(1,6):
    cl_ob.get_vocab_size("/media/crouton/siwuchuk/newdir/vscode_repos_files/method/models/bilstm/20/",20,i)
