...
cl_ob.view_model_summary("/mnt/siwuchuk/vscode/models/bilstm/model/30/main_bilstm_scratch_model_150embedtime1_main_sample_project20_6_5.keras")
...
for i in range(1,6):
    cl_ob.get_vocab_size("/mnt/siwuchuk/vscode/models/bilstm/model/30/",30,i)
