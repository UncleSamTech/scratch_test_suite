...
class bilstm_cybera:
    def consolidate_data_train_parallel(self, train_path, result_path, test_path, model_number, logs_path):
        ...
        for each_run in range(1, 3):  # 2 runs
...
sample = ("/mnt/siwuchuk/thesis/another/kenlm/output_train","/mnt/siwuchuk/thesis/another/bilstm/models/50/","/mnt/siwuchuk/thesis/another/kenlm/output_test",50,"/mnt/siwuchuk/thesis/another/bilstm/logs/50")
