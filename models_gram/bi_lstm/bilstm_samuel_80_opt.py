...
#lines=$(wc -l < scratch_train_set_80_6_1_proc_1.txt) && split -l $((lines / 2)) scratch_train_set_80_6_1_proc_1.txt scratch_train_set_80_6_5_proc_ && mv scratch_train_set_80_6_5_proc_aa scratch_train_set_80_6_5_proc_1.txt && mv scratch_train_set_80_6_5_proc_ab scratch_train_set_80_6_5_proc_2.txt

#lines=$(wc -l < scratch_train_set_80_6_5_proc_1.txt) && split -l $((lines / 2)) scratch_train_set_80_6_5_proc_1.txt scratch_train_set_80_6_5_proc_ && mv scratch_train_set_80_6_5_proc_aa scratch_train_set_80_6_5_proc_3.txt && mv scratch_train_set_80_6_5_proc_ab scratch_train_set_80_6_5_proc_1.txt
#lines=$(wc -l < scratch_train_set_80_6_5_proc_2.txt) && split -l $((lines / 2)) scratch_train_set_80_6_5_proc_2.txt scratch_train_set_80_6_5_proc_ && mv scratch_train_set_80_6_5_proc_aa scratch_train_set_80_6_5_proc_4.txt && mv scratch_train_set_80_6_5_proc_ab scratch_train_set_80_6_5_proc_2.txt