        ...
        with open(test_data,"r",encoding="utf-8") as f:
            ...
            for line in lines:
                ...
                for idx in range(1,len(sentence_tokens)):
                    ...
                    investig_path = f"{new_path}/bilstm_investigate_{proj_number}_2.txt"
