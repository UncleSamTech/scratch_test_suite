...
# Example usage
cl_ob = bilstm_cybera()
sample = ("/mnt/siwuchuk/files/train_data","/mnt/siwuchuk/files/bilstm/models/80/","/mnt/siwuchuk/thesis/another/kenlm/output_test",80,"/mnt/siwuchuk/files/bilstm/logs/80")
