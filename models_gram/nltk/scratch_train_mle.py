...
class scratch_train_mle:
    ...
    def multiple_train_time_metrics(self, list_ngrams, test_data, model_name, train_data,proj_number):
        final_result = {}
        log_file = f"/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_models_ngram3/thesis_models/train_models/train_results/nltk/logs/trained_data_prec_rec_acc_{proj_number}_projects.txt"
            ...
            for each_gram in list_ngrams:
                try:
                    ...
                    with open(log_file, "a") as precs:
                        precs.write(f"Run {each_run} metrics for 10 projects")
...
tr_scr.multiple_train_time_metrics([2,3,4,5,6],"/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_models_ngram3/thesis_models/test_models/test_data/scratch_test_data_20.txt","/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_models_ngram3/thesis_models/train_models/train_results/nltk/models_experiment/scratch_trained_model_nltk_50_projects","/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_models_ngram3/thesis_models/train_models/train_data/scratch_train_data_50_projects.txt","50")
