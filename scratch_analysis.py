...
def describe_data(csv_file):
    ...
    new = val[["Total_Revisions","Source_Files"]].describe()
    resp = new.to_csv("/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_test_suite/sqlite/distinct_file_revisions_per_project_descriptions.csv")
    return resp
...
describe_data("/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_test_suite/sqlite/scratch_distinct_file_revisions_per_project.csv")