...
def describe_data(csv_file):
    ...
    new = val[["Project_Name","Distinct_Author_Count"]].describe()
    resp = new.to_csv("/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_test_suite/sqlite/author_commit_descriptions.csv")
    return resp
...
describe_data("/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_test_suite/sqlite/distinct_author_contribution_per_project.csv")