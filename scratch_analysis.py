...
def plot_histogram_per_distribution(file_path:str,plot_result_path,xlabel,ylabel,title,fig_title,column_title,bins_count):
    ...
    plt.hist(data,color='lightblue', ec='black',bins=bins_count)
    plt.yscale('log')
...
plot_histogram_per_distribution("/media/crouton/siwuchuk/newdir/vscode_repos_files/sb3_extracted_revisions/author_commit/auth_commit_summary/summary/commit_author_name_email_commit_name_commit_email_proj_name_commit_message.csv","/media/crouton/siwuchuk/newdir/vscode_repos_files/sb3_extracted_revisions/all_plots_results","Number of Authors-Committers Per Scratch(sb3) Project","Number of Scratch Projects (Log Scale)","Histogram of Number of Authors-Committers Per Scratch Project","authors_committers_distribution_per_projects","Project_Name",15)
