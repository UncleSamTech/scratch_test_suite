...
def describe_data(csv_file):
    ...
    new = val[["Source_File_Count","Revision_Count","Nodes","Edges"]].describe()
    resp = new.to_csv("/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_test_suite/sqlite/final_all_revisions_descriptions.csv")
    return resp
