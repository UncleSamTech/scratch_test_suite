...
def describe_data(csv_file):
    ...
    new = val[["Project_Name","Author_Email"]].describe()
    resp = new.to_csv("/media/crouton/siwuchuk/newdir/vscode_repos_files/sb3_extracted_revisions/author_commit/auth_commit_summary/author_commit_descriptions.csv")
    return resp
...
#plot_histogram_per_distribution("/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_test_suite/sqlite/scratch_distinct_file_revisions_per_project.csv","/media/crouton/siwuchuk/newdir/vscode_repos_files/sb3_extracted_revisions/all_plots_results","Number of Revisions Per Scratch(sb3) Projects","Number of Scratch Projects (Log Scale)","Histogram of Number of Revisions Per Scratch(sb3) Projects","revisions_distribution_per_projects","Total_Revisions",15)
...
describe_data("/media/crouton/siwuchuk/newdir/vscode_repos_files/sb3_extracted_revisions/author_commit/auth_commit_summary/summary/commit_author_name_email_commit_name_commit_email_proj_name_commit_message.csv")