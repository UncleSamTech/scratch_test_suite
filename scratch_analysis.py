...
def describe_data(csv_file):
    ...
    resp = new.to_csv("/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_test_suite/sqlite/plot_results/scratch_file_per_project_description.csv")
    return resp
...
plot_histogram_per_distribution("/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_test_suite/sqlite/new_scratch_files_per_project.csv","/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_test_suite/sqlite/plot_results","Number of Scratch(sb3) File Per Project (Without Revision)","Number of Scratch Projects (Log Scale)","Histogram of Number of Scratch(sb3) File Per Scratch(sb3) Projects (Without Revisions)","scratch_file_per_project_without_revision_distribution","File_Count",15)
#plot_histogram_per_distribution("/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_test_suite/sqlite/new_nodes_edges_per_file.csv","/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_test_suite/sqlite/plot_results","Number of Edges Per Scratch(sb3) Files","Number of Scratch Files (Log Scale)","Histogram of Number of Edges Per Scratch(sb3) File","edges_distribution_per_file","Edges",25)
...
describe_data("/media/crouton/siwuchuk/newdir/vscode_repos_files/scratch_test_suite/sqlite/new_scratch_files_per_project.csv")
