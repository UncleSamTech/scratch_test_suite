...
def author_commit(path):
    if os.path.isdir(path):
        ...
        if os.path.isfile("/media/crouton/siwuchuk/newdir/vscode_repos_files/sb3_extracted_revisions/author_commit/projnames.txt"):
            os.remove("/media/crouton/siwuchuk/newdir/vscode_repos_files/sb3_extracted_revisions/author_commit/projnames.txt")
